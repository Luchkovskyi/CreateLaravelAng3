    ...
    <div ng-controller="SupplierController">
        <table class="table table-striped">
            ...
            <tr ng-repeat="supplier in suppliers">
                ...
                <td>@{{ supplier.supplierCategories_id }}</td>
                <td><img src="@{{ supplier.supplierImage }}" style="width:100px;height:100px;" ></td>
                <td>
                    ...
                    <div class="modal-body">
                        <form name="frmSupplier" class="form-horizontal" novalidate="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="supplierEmail" name="Description" placeholder="Supplier Email" value="@{{supplierEmail}}" ng-model="supplier.supplierEmail" ng-required="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="supplierContact" name="Category" placeholder="Supplier Contact" value="@{{supplierCategories_id}}" ng-model="supplier.supplierCategories_id" ng-required="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <img src="@{{ supplier.supplierImage }}" style="width:100px;height:100px;" >
                                    ...
                                    <label class="btn btn-default btn-file">
                                        <input id="" ng-model="form.image" type="file"  file-upload="files" multiple file-model="@{{ supplier.supplierImage }}" callback-fn="myCallback" />
                                    </label>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" id="btn-save" ng-click="save(modalstate, id)" ng-disabled="frmSupplier.$invalid" onchange="angular.element(this).scope().uploadedFile(this)">Save Changes</button>
                            </div>
                        </form>
                    </div>
